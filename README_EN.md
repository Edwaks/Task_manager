...
**TaskCapitan** is an environment for managing tasks and digital employees. It is designed for teams, managers, and owners of repeatable processes and combines task assignment, communication, and AI assistance.

- Public URL: https://taskcapitan.ru/
- Core entities: tasks, conversations, assignments, platforms, digital employees, and results.
- Key capabilities: tasks and statuses, communicator, ai secretary, botcap, ai employees, connected platforms, unified work history.

## Why the Product Is Needed

A real workflow rarely consists of a single action. Users must understand the initial situation, gather information, choose the next step, coordinate a decision, and return to the result later. TaskCapitan provides one domain-specific environment for this work. It preserves context between stages and shows not only an individual item, but also its place in the overall process.

The product’s main value is not the number of screens, but workflow continuity. Tasks, conversations, assignments, platforms, digital employees, and results are treated as parts of one user journey. New participants understand the current state faster, experienced specialists spend less time matching information manually, and managers gain a clear overview without requiring every step to be retold.
...
The roles Manager, Assignee, and Digital-employee operator work with the same domain model from different perspectives. Consistent names for objects and states reduce ambiguity during handoffs. A responsible participant can reference a specific object and expected result instead of repeating the entire context.

## Main Sections

The public description covers these user capabilities:

- **Tasks and statuses** — a distinct part of the workflow, connected to the product model and a clear user outcome.
- **Communicator** — a distinct part of the workflow, connected to the product model and a clear user outcome.
- **AI secretary** — a distinct part of the workflow, connected to the product model and a clear user outcome.
- **BotCap** — a distinct part of the workflow, connected to the product model and a clear user outcome.
- **AI employees** — a distinct part of the workflow, connected to the product model and a clear user outcome.
- **Connected platforms** — a distinct part of the workflow, connected to the product model and a clear user outcome.
- **Unified work history** — a distinct part of the workflow, connected to the product model and a clear user outcome.
...
### Taskcapitan
![Taskcapitan](docs/screenshots/taskcapitan.png)

### Taskcapitan ai
![Taskcapitan ai](docs/screenshots/taskcapitan_ai.png)

### Taskcapitan multidoors
![Taskcapitan multidoors](docs/screenshots/taskcapitan_multidoors.png)
